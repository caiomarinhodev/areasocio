# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2017-03-23 18:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('titulo', models.CharField(choices=[('DOUTOR', 'DOUTOR'), ('DOUTORANDO', 'DOUTORANDO'), ('M', 'Mestre'), ('Mestrando', 'Mestrando'), ('Bacharel', 'Bacharel'), ('Graduando', 'Graduando')], max_length=100)),
                ('descricao', models.TextField(verbose_name='Outras Informa\xe7\xf5es')),
